...
class Frame(tk.Frame):
    def __init__(self, root = None):
        super().__init__(root, width= 480, height= 320) # Heredamos constructor de clase padre
        self.root = root
        self.pack()
        #self.config()
    ...
    def campos_pelicula(self):
        ...
        #Botones
        self.boton_nuevo = tk.Button(self, text= 'Nuevo', command = self.habilitarCampos)
        self.boton_nuevo.config(width= 20, font = ('Arial', 12, 'bold'), 
                                fg = '#DAD5D6', bg = '#158645', cursor= 'hand2', activebackground= '#35BD6F')
        self.boton_nuevo.grid(row = 3 , column = 0, padx = 10, pady= 10)
        
        self.boton_guardar = tk.Button(self, text= 'Guardar', command = self.guardarDatos)
        self.boton_guardar.config(width= 20, font = ('Arial', 12, 'bold'), 
                                fg = '#DAD5D6', bg = '#1658A2', cursor= 'hand2', activebackground= '#3586DF')
        self.boton_guardar.grid(row = 3, column = 1, padx = 10, pady= 10)
        
        self.boton_cancelar = tk.Button(self, text= 'Cancelar', command = self.desabilitarCampos)
    ...
    def tabla_peliculas(self):
        # Recuperar a la lista de peliculas
        ...
        #                  values= ('Los Vengadores', '2.35','Acció'))
        # cargamos la lista de peliculas
    ...
    def editar_datos(self):
        try:
            ...
            # Habilitar campos de la taba
            self.habilitarCampos()
            # Asignando valores en los textbox
